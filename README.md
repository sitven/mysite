...
#### 2019-09-16 首页底部添加信息等<br>
1.首页底部添加关于本站等网站信息<br>
2.blog标题和分类信息响应式布局居中显示<br>
3.添加邮箱发送账号与授权码<br>
#### 2019-09-17 界面优化<br>
1.首页热门博客统计响应屏幕布局并行显示<br>
2.添加首页博客描述文件<br>
#### 2019-09-18 首页添加旋转六面体功能<br>
#### 2019-09-29 博客页添加打赏功能<br>
#### 2019-09-20 本地与服务器区分配置文件<br>
1.本地配置文件写入development.py文件<br>
2.服务器配置文件写入production.py文件<br>
3.公共配置文件写入base.py文件<br>
4.本地敏感信息写入环境变量<br>
5.UWSGI+nginx配置的服务器，解决uwsgi无法获得服务器配置情况，服务器敏感信息写入到虚拟运行环境的包文件下新增的var_uwsgi.py文件<br>
#### 2019-09-22 新增404与500页面<br>
1.关闭服务器debug<br>
2.新增404与500页面<br>
3.博客页添加博客分类与博客日期归档<br>
4.解决博文内容空格显示为&nbsp 的bug<br>
#### 2019-09-23 富文本编辑器添加代码功能<br>
1.富文本编辑器添加插入代码功能<br>
2.处理博客页首行换行自动缩进bug<br>
3.首页博客加底色-灰色<br>
4.调整登录or注册框位置与上下间距<br>
5.调整热门博客与底部说明间距<br>
6.调整登录框与注册框样式<br>
#### 2019-09-24 代码与页面优化<br>
1.登录注册css样式写入user.css文件<br>
2.调整登录雨注册框css样式<br>
#### 2019-09-25 首页添加日历等功能<br>
1.首页添加日历功能<br>
2.调整统计图标样式<br>
3.通用模板(base.html)添加返回顶部功能<br>
4.优化用户信息页-侧边栏进度条问题<br>
5.优化base中代码结构,修复404页面返回上一页与首页bug<br>
#### 2019-09-26 归档<br>
个人博客网站： http://www.sitven.cn